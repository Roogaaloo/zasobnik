...
@section('content')
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4>Jak dlouho jste majitelem kočky?</h4>
            </div>
            <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4>Pokud ano, má vliv na lidské zdraví?</h4>
            </div>
            <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4>Pokud ano, co způsobuje? <small>(Můžete zaškrtnout více odpovědí)</small></h4>
            </div>
            <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4>Byla jste v těhotenství ve styku s kočkami?</h4>
            </div>
            <div class="col-sm-12">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4>Trpí Vaše kočka toxoplazmózou?</h4>
            </div>
            <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <p class="well well-sm"><strong>{{ $item->question15 }}</strong></p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <p class="well well-sm"><strong>{{ $item->question16 }}</strong></p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <p class="well well-sm"><strong>{{ $item->question17 }}</strong></p>
            </div>
        </div>
