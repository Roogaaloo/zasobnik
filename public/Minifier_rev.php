...
class Minifier_rev {
    ...
    public function render($minify=true, $version="") {  // final rendering
        ...
        fwrite(fopen("css/rev_style$version.css", "w"), $this->css);
		fwrite(fopen("js/rev_script$version.js", "w"), $this->js);
        echo "<link href='css/rev_style$version.css' rel='stylesheet'>";
